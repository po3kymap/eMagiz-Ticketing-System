  ...
  <div class="min-h-screen bg-slate-50 flex items-center justify-center px-4">
    <div class="w-full max-w-md">
      <div class="text-center mb-8">
        ...
        <p class="text-sm text-slate-500 mt-1">Sign in to the eMagiz Ticketing System</p>
      </div>

      <form class="bg-white border border-slate-200 rounded-2xl shadow-sm p-6 space-y-4" @submit.prevent="onSubmit">
